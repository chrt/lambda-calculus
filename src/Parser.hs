...
action_0,
 ...
 action_19,
 action_20,
 action_21 :: () => Prelude.Int -> ({-HappyReduction (HappyIdentity) = -}
	   Prelude.Int 
	-> (Token)
...
happyExpList = Happy_Data_Array.listArray (0,45) ([5632,5632,512,0,1024,0,5632,0,0,16384,5632,0,0,8192,5632,0,0,2048,5632,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parse","%start_parseCmd","t2","t1","t0","abs","cmd","lambda","var","'.'","'('","')'","'='","%eof"]
...
action_4 (11) = happyShift action_17
...
action_10 (8) = happyGoto action_3
...
action_14 (8) = happyGoto action_3
...
action_18 (8) = happyGoto action_3
...
happyReduction_3 (HappyAbsSyn5  happy_var_2)
	(HappyAbsSyn5  happy_var_1)
	 =  HappyAbsSyn5
		 (NamedAppTerm happy_var_1 happy_var_2
	)
...
happyReduction_9 ((HappyAbsSyn5  happy_var_4) `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn5
		 (NamedAbsTerm (Id happy_var_2) happy_var_4
	) `HappyStk` happyRest
...
happyReduction_10 (HappyAbsSyn5  happy_var_3)
	...
	(HappyTerminal (TokenVar happy_var_1))
	 =  HappyAbsSyn9
		 (AssignCmd (Id happy_var_1) happy_var_3
	)
...
parseCmd tks = happyRunIdentity happySomeParser where
